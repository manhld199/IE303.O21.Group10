...
export default function ProductDeleteMulti() {
  return (
    <button
      className="category-page__btn category-page__save-btn"
      type="button"
      onClick={deleteProducts}>
      <span className="material-icons-round category-page__btn-icon">save</span>
      <span className="category-page__btn-text">Lưu thay đổi</span>
    </button>
  );
}
