...
export default function ProductDeleteMulti() {
  return (
    <button
      className="order-page__btn order-page__btn-delete"
      type="button"
      onClick={deleteProducts}>
      <span className="material-icons-round order-page__btn-icon">delete</span>
      <span className="order-page__btn-text">Xóa</span>
    </button>
  );
}
